...
Note: this works with Claude code as well, just tell it to import MCP servers from the `laude_desktop_config.json` above. It will fix up the formatting and after restarting, the servers will appear in `/mcp`
